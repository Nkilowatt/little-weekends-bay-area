...
const sourceKeys = [
  ...
  "sunnyvale-library-family-events",
  "sunnyvale-family-events",
  "cupertino-library-family-events",
  "cupertino-family-events",
  "santa-clara-library-family-events",
  "santa-clara-family-events",
  "campbell-library-family-events",
...
function seededDatabase() {
  ...
  ) VALUES (?, ?, ?, 'storytime', 'indoor', ?, ?, 'Fixture Library', '1 Main Street, San Mateo, CA', 'venue-fixture-library', 'San Mateo', 1, '1-3세', 12, 47,
...
test("API reports full coverage only when every source is current", async () => {
  ...
  assert.ok(payload.events.every((event) => event.placeKey === "venue-fixture-library"));
});
